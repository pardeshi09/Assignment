...
Bollean operations are simple arithmetic of True and False values.These values can be manipulated by the use of Boolean operators which include AND,OR,and NOT.3. Make a list of each Boolean operator's truth tables .
